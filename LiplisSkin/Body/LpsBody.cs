...
{
    public class LpsBody : BaseLpsBody, ICloneable
    {
        ///=============================
        ///プロパティ
        ...
        #region LpsBody
        public LpsBody(string body11, string body12, string body21, string body22, string body31, string body32, string touch, string bodyDir)
        {
            this.body11 = body11;
            this.body12 = body12;
            this.body21 = body21;
        ...
        public LpsBody(string body11, string body12, string body21, string body22, string body31, string body32, string bodyDir, List<string> lstTouch)
        {
            this.body11 = body11;
            this.body12 = body12;
            this.body21 = body21;
        ...
        {
            return new LpsBody(this.body11, this.body12, this.body21, this.body22, this.body31, this.body32, this.bodyDir, this.lstTouch);
        }
        public LpsBody Clone()
        {
            return new LpsBody(this.body11, this.body12, this.body21, this.body22, this.body31, this.body32, this.bodyDir, this.lstTouch);
        }
        #endregion
