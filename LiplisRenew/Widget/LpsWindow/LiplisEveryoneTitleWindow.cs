//=======================================================================
//  ClassName : LiplisEveryoneTitleWindow
//  概要      : みんなでおしゃべりタイトルウインドウ
//
// iOS版:UiImageに対応
//
//Liplis5.0
...
{
    public class LiplisEveryoneTitleWindow : LiplisWindow
    {
        //=================================
        //ウインドウ要素
        ...
        public LiplisEveryoneTitleWindow(LiplisWidget lips, LiplisWidgetPreference setting, Skin skin, double lpsTop, double lpsLeft, double lpsWidth, LiplisWindowStack windowPos, string title, Uri url, Uri jpgUrl) : base(lips, setting, skin, lpsTop, lpsLeft, lpsWidth, windowPos)
        {
            //ハイパーリンクの生成
        ...
        protected override void initWindow(double lpsTop, double lpsLeft, double lpsWidth, int talkWindowHeightMargin, int talkLabelHeightMargin)
        {
            ...
            this.prgEveryOneTalkGage.Visibility = Visibility.Visible;
            this.lblEveryOneTalkCount.Visibility = Visibility.Visible;
        ...
        /// <param name="e"></param>
        protected override void btnNext_Click(object sender, RoutedEventArgs e)
        {
            this.lips.desk.lpsGilsTalk.nextTopic();
        }
