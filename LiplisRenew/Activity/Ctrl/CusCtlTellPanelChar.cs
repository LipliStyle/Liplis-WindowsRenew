...
namespace Liplis.Activity.Ctrl
{
    public class CusCtlTellPanelChar : CusCtlDataPanel
    {
        ...
        public CusCtlTellPanelChar(LiplisWidget lips,  string url, string title, string discription, int newsEmotion, int newsPoint, Bitmap charBody, EventHandler enter, IContainer components)
        {
            this.lips = lips;
            initCms(components);
