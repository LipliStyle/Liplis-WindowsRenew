...
namespace Liplis.Activity.Ctrl
{
    public class CharPanel : Panel
    {
        ...
        /// </summary>
        #region CharPanel
        public CharPanel(LiplisWidget lips, bool select)
        {
            this.lips = lips;
            this.select = select;
            initDataPanel();
        ...
        {
            XmlLiplisBody obl = lips.skin.xmlBody;
            ...
            this.lnkLbl.Text = lips.skin.charName;
            ...
            this.lblText.Text = lips.skin.xmlSkin.charIntroduction.Replace("@", Environment.NewLine);
            ...
            //イメージ
            if (LpsPathController.checkFileExist(LpsPathController.getSkinPath() + lips.skin.charName + "\\window\\icon.png"))
            {
                this.pic.Image = new Bitmap(new Bitmap(LpsPathController.getSkinPath() + lips.skin.charName + "\\window\\icon.png"), new Size(100, 100));
            }
            else
            {
                this.pic.Image = null;
        ...
        /// <returns></returns>
        #region getIconBmp
        private Bitmap getIconBmp(XmlLiplisBody obl, Bitmap bmp)
        {
            try
            {
