...
namespace Liplis.Com
{
    public static class LpsRegularEx
    {
        ...
        public static string fctReplaceNicoVideoId(string target)
        {
            ...
            return new Regex("sm[0-9]{1,10}").Replace(target, "<a href=\"" + LpsDefine.URL_NICO_VIDEO + "$&\" target=\"_blank\">$&</a>");
        }
        #endregion
        ...
        {
            return new Regex("mylist[0-9]{1,10}").Replace(target, "<a href=\"" + LpsDefine.URL_NICO_DOMAIN + "$&\" target=\"_blank\">$&</a>");
        }
        #endregion
