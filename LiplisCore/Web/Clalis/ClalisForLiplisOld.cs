...
{
    public class ClalisForLiplisOld
    {
        ///=============================
        /// URL定義
        #region URL定義
        ...
        public static MsgTalkMessage getSummaryNews(string uid, string toneUrl, string newsFlg)
        {
            ...
            try
            {
                LpsLogController.d("getSummaryNews");
                NameValueCollection ps = new NameValueCollection();
                ps.Add("tone", toneUrl);                //TONE_URLの指定
                ps.Add("newsFlg", newsFlg);             //NEWS_FLGの指定

                //Jsonで結果取得
                string jsonText = HttpPostOld.sendPost(LIPLIS_API_SUMMARY_NEWS, ps);
        ...
        public static void getSummaryNewsList(Queue<MsgTalkMessage> newsQ, string uid, string toneUrl, string newsFlg, string num, string hour, string already, string twitterMode, string runout)
        {
            try
            {
                //APIの結果受け取り用クラス
                ...
                {
                    MsgTalkMessage msg = convertRlSumNjToMsg(rlsn2);
                    LiplisTag.setTag(msg);
                    newsQ.Enqueue(msg);
                }
            }
        ...
        public static void reloadSummaryNewsList(Queue<MsgTalkMessage> newsQ, string uid, string toneUrl, string newsFlg, string num, string hour, string already, string twitterMode, string runout)
        {
            try
            {
                //APIの結果受け取り用クラス
        ...
        public static ResLpsSummaryNews2JsonList getSummaryNewsList(string uid, string toneUrl, string newsFlg, string num, string hour, string already, string twitterMode, string runout)
        {
            try
            {
                ...
                //Jsonで結果取得
                string jsonText = HttpPostOld.sendPost(LIPLIS_API_SUMMARY_NEWS_LIST, ps);
        ...
        public static MsgTalkMessage getShortNews(string uid, string toneUrl, string newsFlg)
        {
            ...
            try
            {
                ...
                //Jsonで結果取得
                string jsonText = HttpPostOld.sendPost(LIPLIS_API_SHORT_NEWS, ps);
        ...
        public static void getShortNewsList(Queue<MsgTalkMessage> newsQ, string uid, string toneUrl, string newsFlg, string num, string hour, string already, string twitterMode, string runout)
        {
            try
            {
                NameValueCollection ps = new NameValueCollection();
                ...
                //Jsonで結果取得
                string jsonText = HttpPostOld.sendPost(LIPLIS_API_SHORT_NEWS_LIST, ps);
        ...
        /// <returns></returns>
        #region getFreeWord
        public static MsgTalkMessage getFreeWord(string sentence, string tone)
        {
            MsgTalkMessage msg = new MsgTalkMessage();
            try
            {
                LpsLogController.d("getFreeWord");
                NameValueCollection ps = new NameValueCollection();
                ...
                //Jsonで結果取得
                string jsonText = HttpPostOld.sendPost(LIPLIS_FREE_TALK, ps);
        ...
        public static ResLpsLoginRegisterInfoRssEachCat getRLLRIREC(string uid)
        {
            try
            {
                ...
                //Jsonで結果取得
                string jsonText = HttpPostOld.sendPost(LIPLIS_API_GET_RSSLIST, ps);
        ...
        /// </summary>
        #region getRssList
        public static MsgRssList getRssList(string uid)
        {
            MsgRssList resList = new MsgRssList();

            ResLpsLoginRegisterInfoRssEachCat getList = ClalisForLiplisOld.getRLLRIREC(uid);

            //rllriからRSSリストを作成する
            foreach (RegisterRsUserInfoCat rric in getList.rsslist)
            {
                //カテゴリーの器を作成する。
                MsgRssCatList orcl = new MsgRssCatList(rric.cat);

                //回してObjRssCatListに変換する。
                foreach (RegisterRsUserInfo rrui in rric.rsslist)
                {
                    orcl.rssList.Add(new MsgRss(rrui.title, rrui.url, rrui.cat));
                }
        ...
        public static ResLpsLoginStatus registRss(string url, string cat, string uid)
        {
            try
            {
                ...
                //Jsonで結果取得
                string jsonText = HttpPostOld.sendPost(LIPLIS_API_REGISTER_RSS, ps);
        ...
        public static ResLpsLoginStatus deleteRss(string uid, string url)
        {
            try
            {
                ...
                //Jsonで結果取得
                string jsonText = HttpPostOld.sendPost(LIPLIS_API_DELETE_RSS, ps);
        ...
        public static ResLpsLoginRegisterInfoTw getTwitterList(string uid)
        {
            try
            {
                ...
                //Jsonで結果取得
                string jsonText = HttpPostOld.sendPost(LIPLIS_API_GET_TWITTERLIST, ps);
        ...
        public static ResLpsLoginStatus registTwitter(string userName, string uid)
        {
            try
            {
                ...
                //Jsonで結果取得
                string jsonText = HttpPostOld.sendPost(LIPLIS_API_REGISTER_TWITTER, ps);
        ...
        public static ResLpsLoginStatus deleteTwitter(string uid, string userName)
        {
            try
            {
                ...
                //Jsonで結果取得
                string jsonText = HttpPostOld.sendPost(LIPLIS_API_DELETE_TWITTER, ps);
        ...
        public static ResLpsRegisterTwitterInfoRespons twitterRegister(string uid, string token, string secret, string userId, string screanNam)
        {
            try
            {
                ...
                //Jsonで結果取得
                string jsonText = HttpPostOld.sendPost(LIPLIS_API_REGISTER_TWITTER_USER_INFO, ps);
        ...
        public static ResLpsTopicSearchWordList getFilterList(string uid)
        {
            try
            {
                ...
                //Jsonで結果取得
                string jsonText = HttpPostOld.sendPost(LIPLIS_API_GET_SEARCH_WORD, ps);
        ...
        public static ResLpsLoginStatus registFilter(string uid, string topicId, string word, string flgEnable)
        {
            try
            {
                ...
                //Jsonで結果取得
                string jsonText = HttpPostOld.sendPost(LIPLIS_API_REGISTER_SEARCH_WORD, ps);
        ...
        public static ResLpsLoginStatus deleteFilter(string uid, string topicId, string word)
        {
            try
            {
                ...
                //Jsonで結果取得
                string jsonText = HttpPostOld.sendPost(LIPLIS_API_DELETE_SEARCH_WORD, ps);
        ...
        public static ResLpsLoginStatus tweet(string uid, string sentence)
        {
            try
            {
                ...
                //Jsonで結果取得
                string jsonText = HttpPostOld.sendPost(LIPLIS_TWEET, ps);
        ...
        public static ResUserOnetimePass getOneTimePass(string uid)
        {
            try
            {
                ...
                //Jsonで結果取得
                string jsonText = HttpPostOld.sendPost(LIPLIS_API_GET_ONETIME_PASS, ps);
        ...
        public static ResLiplisId getLiplisId(string oneTimePass)
        {
            try
            {
                ...
                //Jsonで結果取得
                string jsonText = HttpPostOld.sendPost(LIPLIS_API_GET_USERID, ps);
        ...
        public static ResLpsLoginStatus saveTopicSetting(string userId, string range, string already, string f_ne, string f_2c, string f_ni, string f_rs, string f_tp, string f_tm, string f_tr, string f_tmode, string f_runout)
        {
            try
            {
                ...
                //Jsonで結果取得
                string jsonText = HttpPostOld.sendPost(LIPLIS_API_TOPIC_SETTING, ps);
        ...
        protected static MsgTalkMessage convertRlSumNjToMsg(ResLpsSummaryNews2Json rlsn2)
        {
            //ディスクリプションチェック
            ...
            {
                msg.jpgUrl = WedFileDownLoader.downLoadthumb(rlsn2.jpgUrl);
            }
            else
            {
                msg.jpgUrl = "";
        ...
        private static MsgTalkMessage convertRlShtNjToMsg(ResLpsShortNews2Json rlsn2)
        {
            //結果メッセージを作成
            MsgTalkMessage msg = new MsgTalkMessage();
