...
//=======================================================================
//  ClassName : ReadJEnc
//  概要      : 文字コード自動判別ライブラリ・処理本体
//
//Liplis5.0
//
//MITライセンスに基づき、使用させていただいております。
//著作権表示は上の通りです。
//=======================================================================
using System;
using System.Text;
...
namespace Liplis.Web.WebEncoding
{
    /// <summary>
    ...
    {   ////////////////////////////////////////////////////////////////////////
        ...
        /// <returns></returns>
        public static bool jpCheck(string str)
        {
            string test = "";
            ...
            //ShiftJisでバイトコード変換　日本語以外であれば、いきなりここでバグる
            byte[] byteSjis = Encoding.GetEncoding("shift_jis").GetBytes(str);

            //判定エンジンに入れる。日本語であれば、ShiftJisでそのまま帰ってくるはず。
            CharCode cc = re.GetEncoding(byteSjis, byteSjis.Length, out test);

            return !Regex.IsMatch(test, @"\?{6}");
        }
        #endregion
